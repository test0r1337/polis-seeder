...
public:
  ...
  void ParseCommandLine(int argc, char **argv) {
    static const char *help = "Polis-seeder\n"
...
static const string mainnet_seeds[] = {"dnsseed.poliscentral.org", "polis.seeds.mn.zone"};
static const string testnet_seeds[] = {"dnsseed-testnet.poliscentral.org", "dnsseed-testnet2.poliscentral.org"};
static const string *seeds = mainnet_seeds;

extern "C" void* ThreadSeeder(void*) {
  if (!fTestNet){
    db.Add(CService("polispay.org", 24126), true);
  }
  do {
